...
namespace ABCMusic_Auth.Controllers
{
    public class SongsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SongId,Name,ArtistName,AlbumName,TrackNumber,ReleaseDate,Publisher")] Song song)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SongId,Name,ArtistName,AlbumName,TrackNumber,ReleaseDate,Publisher")] Song song)
        {
            if (id != song.SongId)
            {
                return NotFound();
